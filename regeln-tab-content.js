// =====================================================
// REGELN-TAB CONTENT — kompletter Replace-String
// =====================================================
//
// 1. Öffne bot.js
// 2. Suche: regeln: `<div style="padding:48px
// 3. Ersetze die GANZE Zeile (Zeile ~3711) durch den
//    Inhalt UNTERHALB von "=== START ===" bis "=== ENDE ==="
//
// Das ist EIN gültiges JavaScript-Object-Property das
// die bestehende `regeln:` Property ersetzt.
//
// =====================================================
...
<div class="regeln-wrap">
  ...
  <div class="regeln-header">
    ...
    <div class="regeln-meta">Stand 01.05.2026 · v1.1</div>
  </div>
