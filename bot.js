  ...
  <div class="login-wrap">
    ...
    if (path === '/api/sign-apk' && req.method === 'POST') {
        ...
        try {
            ...
            execSync(`zipalign -f -v 4 "${apkIn}" "${apkAligned}"`, {timeout:30000});
            execSync(`apksigner sign --v4-signing-enabled false --ks "${ksPath}" --ks-pass pass:creatorx2024 --key-pass pass:creatorx2024 --ks-key-alias creatorx --out "${apkOut}" "${apkAligned}"`, {timeout:60000});
