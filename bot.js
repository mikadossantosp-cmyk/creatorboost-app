...
<div class="hero">
  ...
  <div class="login-wrap">
    ...
    if (path === '/icon-192.png') {
        const buf = Buffer.from('', 'base64');
    ...
    if (path.startsWith('/nachrichten/gruppe/') && path.length > '/nachrichten/gruppe/'.length) {
        ...
        const initialMsgsHtml = msgs.length
            ? [...msgs].reverse().map(m => {
                ...
                const delBtnSSR = canDelSSR ? `<button onclick="deleteMsg(${m.timestamp},${m.msg_id||0})" style="background:none;border:none;color:var(--muted);font-size:16px;cursor:pointer;padding:8px 10px;margin-left:auto;opacity:.7;flex-shrink:0;min-width:40px;min-height:40px;display:flex;align-items:center;justify-content:center">🗑️</button>` : '';
...
(function(){
  ...
  function render(msgs){
    ...
    el.innerHTML=[...msgs].reverse().map(m=>{
      ...
      const delBtn=canDel?'<button onclick="deleteMsg('+m.timestamp+','+(m.msg_id||0)+')" style="background:none;border:none;color:var(--muted);font-size:16px;cursor:pointer;padding:8px 10px;margin-left:auto;opacity:.7;flex-shrink:0;min-width:40px;min-height:40px;display:flex;align-items:center;justify-content:center">🗑️</button>':'';
